...
* MPI+HIP code implementating a 2D lid-driven cavity flow.
* D2Q9 lattice
* 
*/
...
int main(int argc, char** argv) {
    ...
    hipMallocManaged((void**)&distr,_LX_ * my_ly_ext * _STENCILSIZE_ * sizeof(double));
    hipMallocManaged((void**)&distrAdv,_LX_ * my_ly_ext * _STENCILSIZE_ * sizeof(double));
    hipMallocManaged((void**)&stencilOpPt,_LX_ * my_ly_ext * _STENCILSIZE_ * sizeof(int));
    ...
    double* bufferSend;
    double* bufferRecv;
    hipMallocManaged((void**)&locsToSendGPU,nTotSendLocs*sizeof(int));
    hipMallocManaged((void**)&locsToRecvGPU,nTotRecvLocs*sizeof(int));
    hipMallocManaged((void**)&bufferSend,nTotSendLocs*sizeof(double));
    hipMallocManaged((void**)&bufferRecv,nTotRecvLocs*sizeof(double));
    hipMemcpy(locsToSendGPU,locsToSend.data(),nTotSendLocs*sizeof(int),hipMemcpyHostToDevice);
    hipMemcpy(locsToRecvGPU,locsToRecv.data(),nTotRecvLocs*sizeof(int),hipMemcpyHostToDevice);
